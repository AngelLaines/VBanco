...
Public Class FrmRetiro
    ...
    Private Sub txtNombProp_TextChanged(sender As Object, e As EventArgs)
    ...
    Private Sub BtnAceptar_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Dim sentsql As String
            sentsql = "insert into Movimientos values(" & IdEmpActivo & "," & txtMovimiento.Text & "," & txtCodigo.Text & "," & txtNoCuenta.Text & "," & txtCantidad.Text & "','" & Format(Now, "dd/MM/yyyy") & "','" & Format(Now, "hh:mm") & "')"
            ...
            MessageBox.Show("El retiro ha sido guardado con exito.", "Guardando retiro...")
        ...
        Try
            ...
            SentSQLinsert = "INSERT INTO [OPERACIONES](OPERACION, QUIEN, [AQUIEN], FECHA, HORA, NOACCESO) VALUES('RETIRO EFECTIVO'," & IdEmpActivo & "," & txtCodigo.Text & ",'" & Format(Now, "dd/MM/yyyy") & "','" & Format(Now, "hh:mm") & "'," & NumAcceso & ")"
    ...
    Private Sub BtnBuscar2_Click(sender As Object, e As EventArgs) Handles BtnBuscar2.Click
        Try
            Dim SentSQL As String
            SentSQL = "Select idcliente FROM tarjetas Where notarjeta=" & txtCodigo.Text
    ...
    Private Sub BtnAceptar_Click_1(sender As Object, e As EventArgs) Handles BtnAceptar.Click
        ...
        Try
            ...
            Dim sentsql As String
            sentsql = "insert into Movimientos values(" & txtMovimiento.Text & ",'" & Format(Now, "dd/MM/yyyy") & "','" & Format(Now, "hh:mm") & "','Retiro'," & txtCantidad.Text & "'," & txtCodigo.Text & "," & txtNoCuenta.Text & "," & IdEmpActivo & ")"
        ...
        Try
            ...
            SentSQLinsert = "INSERT INTO [OPERACIONES](OPERACION, QUIEN, [AQUIEN], FECHA, HORA, NOACCESO) VALUES('DEPOSITO EFECTIVO'," & IdEmpActivo & "," & txtCodigo.Text & ",'" & Format(Now, "dd/MM/yyyy") & "','" & Format(Now, "hh:mm") & "'," & NumAcceso & ")"
            Dim comando As New OleDbCommand(SentSQLinsert, conexion)
